...
interface ContactProps {
  t: Translations["es"]["contact"] // Type for contact translations
}

export default function Contact({ t }: ContactProps) {
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    // Aquí podrías añadir la lógica para enviar el formulario, por ejemplo, a una API o un servicio de email.
    alert(t.sentMessage)
